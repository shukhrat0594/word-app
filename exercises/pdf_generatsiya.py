...
QISM_PROMPT = (
    ...
    "shunchaki paragraf harfi). Bunda \"variantlar\"ga passage'dagi "
    "paragraf harflarini YOZING (masalan 6 paragraf A-F bo'lsa "
    "[\"A\",\"B\",\"C\",\"D\",\"E\",\"F\"]) — bu holatda harf TO'G'RI, "
    "chunki boshqa matn yo'q, paragraf o'zi javob variantidir. "
    "\"variantlar\"ni BO'SH QOLDIRMANG — bo'sh qoldirilsa savol noto'g'ri "
    "(oddiy matn-input) ko'rinishda chiqadi.\n"
    "  Ikkala holatda ham: bitta ro'yxat/harf to'plamidan bir nechta "
    "savol foydalansa, HAMMASIGA BIR XIL to'liq \"variantlar\" ro'yxatini "
    "bering (aynan bir xil massiv, tartib ham bir xil) — aks holda "
    "savollar guruhlanmay, alohida-alohida noto'g'ri ko'rinishda chiqadi.\n"
