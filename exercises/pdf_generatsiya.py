...
QISM_PROMPT = (
    ...
    "- **\"matching_headings\" (List of Headings)**: bu turda "
    "\"variantlar\" HECH QACHON bo'sh qolmasin. Kitobda alohida qutida "
    "\"List of Headings\" bo'ladi (i, ii, iii... bilan raqamlangan). "
    "Shu qutidagi HAR BIR sarlavhani TO'LIQ MATNI bilan, o'z raqami "
    "bilan birga \"variantlar\"ga yozing — masalan [\"i The rise of "
    "urban farming\", \"ii A surprising discovery\", ...]. FAQAT "
    "raqamlarni ([\"i\",\"ii\"]) yozish YETARLI EMAS: talaba raqam "
    "nimani anglatishini bilmay qoladi va javob yozolmaydi.\n"
    "  Shu guruhdagi HAMMA savolga AYNAN BIR XIL to'liq ro'yxatni "
    "bering (tartib ham bir xil) — aks holda savollar guruhlanmaydi va "
    "sarlavhalar ro'yxati talabaga UMUMAN ko'rsatilmaydi (foydalanuvchi "
    "2026-08-08 da aynan shu holatni uchratdi: paragraflar ostida "
    "sarlavhalar o'rniga bo'sh matn maydonlari chiqqan).\n"
    "  \"savol\" maydoniga paragraf belgisini yozing (\"Paragraph A\"), "
    "\"togri\"ga esa to'g'ri sarlavhani — variantlardagi bilan AYNAN "
    "bir xil matn.\n"
