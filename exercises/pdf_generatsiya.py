...
QISM_PROMPT = (
    ...
    "— harflarni ([\"A\",\"B\",...]) YOZMANG. Sabab: bu holatda harf "
    "o'zi-o'ziga mos keladi (A->A, B->B...), shuning uchun alohida "
    "variant-quti ko'rsatish HECH QANDAY qo'shimcha ma'lumot bermaydi, "
    "faqat chalkashtiradi — talaba shunchaki paragraf harfini (A, B, "
    "C...) to'g'ridan-to'g'ri yozib javob beradi, xuddi qisqa-javob "
    "savoli kabi.\n"
