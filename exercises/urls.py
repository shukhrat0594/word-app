...
urlpatterns = [
    ...
    path(
        "imtihon/papkalar/<int:pk>/eksport/",
        views.TestPapkaEksportView.as_view(),
        name="imtihon_papka_eksport",
    ),
    path(
    ...
    path("imtihon-mock/papkalar/", views.MockPapkalarView.as_view(), name="imtihon_mock_papkalar"),
