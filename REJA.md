...
| **B4** | Testlar/Mashqlar — **Listening va Reading (har biri 5 tur, real IELTS formatida)** | **Listening:** Multiple Choice, Fill in the Blanks, Matching, Plan/Map/Diagram Labelling (rasm + raqamlangan nuqtalar), Short Answer. **Reading:** Multiple Choice, Fill in the Blanks, Matching Headings, True/False/Not Given, Short Answer — hammasi avtomatik tekshiriladi (AI shart emas). Yetkazish B3.2 talablariga mos (API orqali, export yo'q) | Har 5 turdan test yaratib, avtomatik natijani tekshirish |
